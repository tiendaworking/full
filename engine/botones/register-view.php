...
<div class="panel panel-default">
  ...
  <div class="form-group">
    ...
    <input type="text" name="lastname" class="form-control" id="exampleInputEmail1" placeholder="Apellidos">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="password" name="confirm_password" class="form-control" id="exampleInputPassword1" placeholder="Confirmar Password">
  </div>
  <div class="checkbox">
    <label>
